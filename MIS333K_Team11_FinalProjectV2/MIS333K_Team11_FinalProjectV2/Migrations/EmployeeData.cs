...
namespace MIS333K_Team11_FinalProjectV2.Migrations
{
	public class EmployeeData
	{
		...
		public void AddEmployee(AppDbContext db)
		{
			...
			AppUser employee1 = db.Users.FirstOrDefault(u => u.Email == "e.rice@longhorncinema.com");

			if (employee1 == null)
			{
				employee1 = new AppUser();
				employee1.UserName = "e.rice@longhorncinema.com";
				employee1.Email = "e.rice@longhorncinema.com";
				employee1.FirstName = "Eryn";
				employee1.LastName = "Rice";
				employee1.MiddleInitial = "M";
				employee1.PhoneNumber = "9073876657";
				employee1.Birthday = new DateTime(1959, 7, 2);
				employee1.Street = "3405 Rio Grande";
				employee1.City = "Austin";
				employee1.State = StateAbbr.TX;
				employee1.ZipCode = "78746";

				var result = UserManager.Create(employee1,"ricearoni");
				db.SaveChanges();
				employee1 = db.Users.First(u => u.UserName == "e.rice@longhorncinema.com");
			...
			AppUser employee2 = db.Users.FirstOrDefault(u => u.Email == "r.taylor@longhorncinema.com");

			if (employee2 == null)
			{
				employee2 = new AppUser();
				employee2.UserName = "r.taylor@longhorncinema.com";
				employee2.Email = "r.taylor@longhorncinema.com";
				employee2.FirstName = "Rachel";
				employee2.LastName = "Taylor";
				employee2.MiddleInitial = "O";
				employee2.PhoneNumber = "9074512631";
				employee2.Birthday = new DateTime(1972, 12, 20);
				employee2.Street = "345 Longview Dr.";
				employee2.City = "Austin";
				employee2.State = StateAbbr.TX;
				employee2.ZipCode = "78746";

				var result = UserManager.Create(employee2,"swansong");
				db.SaveChanges();
				employee2 = db.Users.First(u => u.UserName == "r.taylor@longhorncinema.com");
			...
			AppUser employee3 = db.Users.FirstOrDefault(u => u.Email == "a.rogers@longhorncinema.com");

			if (employee3 == null)
			{
				employee3 = new AppUser();
				employee3.UserName = "a.rogers@longhorncinema.com";
				employee3.Email = "a.rogers@longhorncinema.com";
				employee3.FirstName = "Allen";
				employee3.LastName = "Rogers";
				employee3.MiddleInitial = "H";
				employee3.PhoneNumber = "9078752943";
				employee3.Birthday = new DateTime(1978, 6, 21);
				employee3.Street = "4965 Oak Hill";
				employee3.City = "Austin";
				employee3.State = StateAbbr.TX;
				employee3.ZipCode = "78705";

				var result = UserManager.Create(employee3,"evanescent");
				db.SaveChanges();
				employee3 = db.Users.First(u => u.UserName == "a.rogers@longhorncinema.com");
			...
			AppUser employee4 = db.Users.FirstOrDefault(u => u.Email == "w.sewell@longhorncinema.com");

			if (employee4 == null)
			{
				employee4 = new AppUser();
				employee4.UserName = "w.sewell@longhorncinema.com";
				employee4.Email = "w.sewell@longhorncinema.com";
				employee4.FirstName = "William";
				employee4.LastName = "Sewell";
				employee4.MiddleInitial = "G";
				employee4.PhoneNumber = "9074510084";
				employee4.Birthday = new DateTime(1986, 5, 25);
				employee4.Street = "2365 51st St.";
				employee4.City = "Austin";
				employee4.State = StateAbbr.TX;
				employee4.ZipCode = "78755";

				var result = UserManager.Create(employee4,"walkamile");
				db.SaveChanges();
				employee4 = db.Users.First(u => u.UserName == "w.sewell@longhorncinema.com");
